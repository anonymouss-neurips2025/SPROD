...
def train_and_test_erm(seed, args):
    ...
    all_train_loader, val_loader, test_loader = get_waterbird_loaders(path=args.data_path,
                                                           batch_size=args.batch_size, use_train_transform=True, seed=seed)
    ...
    for epoch in range(1, 31):
        ...
        if val_acc[-1] > best_acc:
            ...
            torch.save(model.state_dict(), os.path.join(save_dir, 
                                                        'ViT_S_waterbirds_'+ str(args.r)+'_best_checkpoint_seed' + str(
                                                            args.seed) +  '.model'))
...
if __name__ == "__main__":
    ...
    correlation = 90
    default_data_path = os.path.join(dataset_root, f'Waterbirds_dataset/waterbird_complete{correlation}_forest2water2')
    ...
    parser.add_argument("--r", type=int, default=correlation)
